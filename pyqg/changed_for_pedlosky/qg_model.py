...
class QGModel(model.Model):
    ...
    def __init__(
        ...
        V1=0.025,                   # upper layer flow
        V2=0.0,                     # lower layer flow
        **kwargs
        ):
        """
        Parameters
    ...
    def _initialize_background(self):
        ...
        self.Qx1 = - self.F1*(self.V1 - self.V2)
        self.Qx2 =   self.F2*(self.V1 - self.V2)
